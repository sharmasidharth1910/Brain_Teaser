...
public class AverageAdapter extends ArrayAdapter<Average> {
    ...
    private final ArrayList<Average> values;

    public AverageAdapter(@NonNull Context context, ArrayList<Average> list) {
        super(context, R.layout.leader_board_1, list);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.leader_board_1, parent, false);
